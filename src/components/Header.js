...
function Header() {
  ...
  const searchCache = useSelector((store) => store.search);  const dispatch = useDispatch();
    ...
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      ...
      <div className="col-span-10 px-10">
        <div>
          ...
          />
          <button className="px-5 py-2 rounded-r-full border border-gray-400 bg-gray-100">
            🔍
          </button>
        </div>
        {showSuggestions && (
